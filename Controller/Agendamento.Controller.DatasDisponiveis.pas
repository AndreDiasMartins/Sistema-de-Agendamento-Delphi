...
type
  ...
  public
    ...
    function OpenDataDisponiveis(var Query: TFDMemTable; AParams: Array of variant; out StrErr: string): Boolean;
    function OpenHoraDisponiveis(var Query: TFDMemTable; AParams: Array of variant; out StrErr: string): Boolean;
...
function TDatasDisponiveisController.OpenDataDisponiveis(var Query: TFDMemTable; AParams: array of variant; out StrErr: string): Boolean;
begin
  Result := FDatasDisponiveisDAO.OpenDataDisponivel(Query, AParams, StrErr);

end;

function TDatasDisponiveisController.OpenHoraDisponiveis(var Query: TFDMemTable; AParams: array of variant; out StrErr: string): Boolean;
begin
  Result := FDatasDisponiveisDAO.OpenHoraDisponivel(Query, AParams, StrErr);
end;
